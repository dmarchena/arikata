...
const statusCodes = {
  ok: 200, // Returned by a successful GET or DELETE operation. PUT or POST can also use this, if the service does not want to return a resource back to the client after creation or modification.
...
katasRouter.get('/katas/:id', (req, res) => {
  app.browseService.getKataWithId(req.params.id).then((data) => res.json(data));
});
